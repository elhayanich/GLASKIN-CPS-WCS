...
import quizImage from "../assets/images/quiz.jpg";
import favoriteIcon from "../assets/images/favorite.png"; 
import skinproducts from "../assets/data/skinproducts.json"; // Importing the skin products data

export default function Quiz() {
    const [products] = useState(skinproducts); // Directly using the imported data
    const [answer, setAnswer] = useState('');
    const [filteredProducts, setFilteredProducts] = useState([]);
